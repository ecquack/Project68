...
long DubW=0x600; // one page past the end of the 40 column console RAM
int DubL,DubH;
#locate DubW=0x56
#locate DubH=DubW+1
#locate DubL=DubW

long Dub2W=0x700; // two pages past the end of the 40 column console RAM
int Dub2L,Dub2H;
#locate Dub2W=0x58
...
void DoHalfSyncNeg(void)
{
   ...
   int heven=0,hodd=1;       // interlace mode- not fully implemented
   #locate hline=0x50
