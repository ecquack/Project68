...
#define  HBackPorch     16          // horizontal backporch in 4 pixel units
#endif
...
//
// EUSART 2
// some chips have a second serial port. we use it to talk to the host
//
...
void InitSystem(void)
{
 ...
 InitConsoleRAM1();
   ...
   SLRCON^=PORTC_SLEW;      // decrease port C slew rate for CRTs
   BAUDCON=0;
